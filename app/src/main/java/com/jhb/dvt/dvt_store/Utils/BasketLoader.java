...
/**
 * Created by Hmdau on 2016/03/02.
 */
public class BasketLoader extends AsyncTask<Void, Void, String> implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    public BasketLoader(SliderLayout mDemoSlider, Context context, String call, FragmentManager supportFragmentManager) {
    ...
    public void getBasketProducts() {
        for (Item basketItem : items) {
            ...
            customSlider.description(basketItem.getName())
                    .image(basketItem.getImageUrl())
                    .setScaleType(BaseSliderView.ScaleType.Fit)
                    .setOnSliderClickListener(this);
            customSlider.setPrice(basketItem.getPrice());
